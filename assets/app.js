...
const copy = {
  zh: {
    ...
    decisions: {
      ...
      trimHeat: ["过热锁利", "本月新增资金的 50% 买核心 QQQ；同时卖出约 1/12 TQQQ，但保留 20% TQQQ 底仓。", "买 QQQ 与卖 TQQQ 是降低杠杆、保留市场参与，不是方向互相抵消。"],
    ...
    actions: {
      ...
      trimHeat: { title: "过热锁利", condition: "CAPE 泡沫警戒持续 6 个月以上", operation: "50% 月投入买 QQQ；卖出约 1/12 TQQQ并保留 20% 底仓" },
    ...
    guides: {
      ...
      mixed: {
        ...
        actions: {
          ...
          trimHeat: "50% 月投入买 QQQ；卖出约 1/12 TQQQ，但保留 20% TQQQ 底仓。",
  ...
  en: {
    ...
    decisions: {
      ...
      trimHeat: ["Trim heat", "Invest 50% of the monthly contribution in core QQQ while selling about 1/12 of TQQQ and keeping a 20% TQQQ floor.", "Buying QQQ while selling TQQQ reduces leverage while preserving market participation."],
    ...
    actions: {
      ...
      trimHeat: { title: "Trim heat", condition: "Bubble-watch CAPE lasts 6+ months", operation: "Put 50% of monthly cash into QQQ; sell about 1/12 of TQQQ above its 20% floor" },
    ...
    guides: {
      ...
      mixed: {
        ...
        actions: {
          ...
          trimHeat: "Put 50% of monthly cash into QQQ; sell about 1/12 of TQQQ while keeping a 20% floor.",
